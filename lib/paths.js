...
// Vault paths — uses existing "obsisian" spelling for backwards compatibility
const VAULT_DIR = path.join(HOME, '.claude', '.claude', 'obsisian', 'Skill Advisor Claude code');
