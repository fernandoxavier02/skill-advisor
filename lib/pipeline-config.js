 ...
 *   - All exported data containers are deeply Object.freeze'd. Note that
 *     freeze enforcement only throws TypeError under strict mode; in sloppy
 *     mode mutations fail silently. The plugin runs all source files with
 *     'use strict' so frozen mutations DO throw at runtime — but consumers
 *     that disable strict mode will silently corrupt local references.
